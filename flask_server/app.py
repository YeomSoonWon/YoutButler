...
def chat():
    ...
    {{
        ...
        "paying_off_period": 대출 상품의 정보가 주어지고 사용자의 채팅에 상환 기간에 대한 내용이 있었다면 그 값이 int 형태로 들어갑니다 그렇지 않다면 빈 값이 들어갑니다,
        "paying_off_amount": 대출 상품의 정보가 주어지고 사용자의 채팅에 상환 금액에 대한 내용이 있었다면 그 값이 int 형태로 들어갑니다 그렇지 않다면 빈 값이 들어갑니다,
