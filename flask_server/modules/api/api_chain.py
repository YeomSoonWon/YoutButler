...
from flask_server.modules.api.prompt import PROMPT
from flask_server.modules.resources.resource import Resource, format_resources
...
class APIChain(Chain):
    ...
    def _call(self, inputs: Dict[str, str]) -> Dict[str, str]:
        ...
        # error, result = "", "Executed successfully" #
