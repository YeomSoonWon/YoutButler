...
public class SearchCommand {
    ...
    // 가격
    private String dwMin; // 보증금/전세가 최소
    private String dwMax;
    private String dpMin; // 매매가 최소
    private String dpMax;
    private String rpMin; // 월세
    private String rpMax;
    private String mfMin; // 관리비
    private String mfMax;
    private String rsMin;
    private String rsMax;
    private String uay; // 사용 승인일 기간 (다중택일)
